...
/* harmony import */ var _models_base__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./models/base */ "./src/js/models/base.ts");
/* harmony import */ var _models_input__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./models/input */ "./src/js/models/input.ts");
/* harmony import */ var _music__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./music */ "./src/js/music.ts");
...
var playerColor = new _models_base__WEBPACK_IMPORTED_MODULE_5__["Color"](0, 0, 100);
// HTML elements
...
var mouse = new _models_input__WEBPACK_IMPORTED_MODULE_6__["Mouse"]();
var keys = new _models_input__WEBPACK_IMPORTED_MODULE_6__["Keys"]();
var frame;
var score;
var level;
var combo;
...
var startTime;
function init() {
    mouse = new _models_input__WEBPACK_IMPORTED_MODULE_6__["Mouse"]();
    keys = new _models_input__WEBPACK_IMPORTED_MODULE_6__["Keys"]();
    canvas.width = innerWidth;
    canvas.height = innerHeight - inforBarEl.clientHeight;
    topLeft = new _models_base__WEBPACK_IMPORTED_MODULE_5__["Point"](padding, padding);
    bottomRight = new _models_base__WEBPACK_IMPORTED_MODULE_5__["Point"](canvas.width - padding, canvas.height - padding);
    center = new _models_base__WEBPACK_IMPORTED_MODULE_5__["Point"](canvas.width / 2, canvas.height / 2);
    score = 0;
    combo = 0;
    frame = 0;
    level = 1;
    ...
    player = new _models_player__WEBPACK_IMPORTED_MODULE_1__["Player"](new _models_base__WEBPACK_IMPORTED_MODULE_5__["Point"](bottomRight.x / 2, bottomRight.y / 2), playerColor, keys);
    projectiles = [];
    particles = new _models_particles__WEBPACK_IMPORTED_MODULE_4__["Particles"]();
    enemies = [];
    powerUps = [];
    backgroundParticles = new _models_particles__WEBPACK_IMPORTED_MODULE_4__["BackgroundParticles"](topLeft, bottomRight, spacing);
    if (!bgMusic) {
        bgMusic = new _music__WEBPACK_IMPORTED_MODULE_7__["BackgroundMusic"]();
    }
    else if (bgMusic.isBoss) {
        bgMusic.fade(2000);
        setTimeout(function () { return bgMusic.setSong(_music__WEBPACK_IMPORTED_MODULE_7__["defaultSong"]); }, 2000);
    }
    spawnPoints = [
        new _models_base__WEBPACK_IMPORTED_MODULE_5__["Point"](0, 0),
        new _models_base__WEBPACK_IMPORTED_MODULE_5__["Point"](canvas.width / 4, 0),
        new _models_base__WEBPACK_IMPORTED_MODULE_5__["Point"](canvas.width / 2, 0),
        new _models_base__WEBPACK_IMPORTED_MODULE_5__["Point"](3 * canvas.width / 4, 0),
        new _models_base__WEBPACK_IMPORTED_MODULE_5__["Point"](0, canvas.height / 3),
        new _models_base__WEBPACK_IMPORTED_MODULE_5__["Point"](0, 2 * canvas.height / 3),
        new _models_base__WEBPACK_IMPORTED_MODULE_5__["Point"](0, canvas.height),
        new _models_base__WEBPACK_IMPORTED_MODULE_5__["Point"](canvas.width / 4, bottomRight.y),
        new _models_base__WEBPACK_IMPORTED_MODULE_5__["Point"](canvas.width / 2, bottomRight.y),
        new _models_base__WEBPACK_IMPORTED_MODULE_5__["Point"](3 * canvas.width / 4, bottomRight.y),
        new _models_base__WEBPACK_IMPORTED_MODULE_5__["Point"](bottomRight.x, canvas.height / 3),
        new _models_base__WEBPACK_IMPORTED_MODULE_5__["Point"](bottomRight.x, 2 * canvas.height / 3),
        new _models_base__WEBPACK_IMPORTED_MODULE_5__["Point"](bottomRight.x, canvas.height),
    ];
    setTimeout(function () { return spawnBoss(); }, 20000);
}
function animate() {
    ...
    enemies.forEach(function (enemy, index) {
        ...
        projectiles.forEach(function (projectile) {
            ...
            if (dist < 1) {
                ...
                if (enemy.hit(projectile.power)) {
                    ...
                    particles.create(projectile.center, enemy.color, splashAmount_1, splashAngle);
                    addScore(enemy.points, projectile);
                    // remove enemy after some time for it to fade 
                    setTimeout(function () { return enemies = enemies.filter(function (e) { return e.id !== enemy.id; }); }, 100);
                }
            }
        });
        if (enemy.inPlay) {
        ...
        for (var i = index + 1; i < enemies.length; i++) {
            ...
            if (enemy.distanceBetween(e) < 1) {
                ...
                var collisionPoint = new _models_base__WEBPACK_IMPORTED_MODULE_5__["Point"](enemy.center.x + Math.cos(angle) * enemy.radius, enemy.center.y + Math.sin(angle) * enemy.radius);
...
function spawnEnemy(level) {
    var e;
    if (Math.random() < 0.3) {
        e = new _models_enemies__WEBPACK_IMPORTED_MODULE_2__["HomingEnemy"](randomSpawnPoint(), player.center, level);
    }
    else if (Math.random() < 0.15) {
        e = new _models_enemies__WEBPACK_IMPORTED_MODULE_2__["OscilatingEnemy"](randomSpawnPoint(), center, level);
    }
    else {
        e = new _models_enemies__WEBPACK_IMPORTED_MODULE_2__["Enemy"](randomSpawnPoint(), player.center, level);
    }
    enemies.push(e);
}
function spawnBoss() {
    ...
    setTimeout(function () { return bgMusic.fade(6000); }, 0);
    setTimeout(function () { return bgMusic.setSong(_music__WEBPACK_IMPORTED_MODULE_7__["bossMusicURL"]); }, 10000);
    var pushBoss = function () { return enemies.push(new _models_enemies__WEBPACK_IMPORTED_MODULE_2__["Boss"](randomSpawnPoint(), player)); };
...
function spawnEnemies(level) {
    ...
    if (level > 1)
        spawnEnemy(1);
    if (level > 2 && ticker % 2 === 0)
        spawnEnemy(2);
    if (level > 3 && ticker % 2 === 0)
        spawnEnemy(3);
...
function spawnPowerUp() {
    powerUps.push(new _models_powerups__WEBPACK_IMPORTED_MODULE_3__["PowerUp"](randomSpawnPoint(), new _models_base__WEBPACK_IMPORTED_MODULE_5__["Point"](canvas.width / 2, canvas.height / 2)));
}
function winGame() {
    ...
    winSound.play();
    bgMusic.setSong(_music__WEBPACK_IMPORTED_MODULE_7__["victoryMusicURL"]);
    scene.active = false;
...
addEventListener('click', function (_a) {
    var clientX = _a.clientX, clientY = _a.clientY;
    mouse.point.x = clientX;
    mouse.point.y = clientY;
    if (scene.active) {
...
var Enemy = /** @class */ (function (_super) {
    ...
    function Enemy(spawnPoint, target, level) {
        ...
        _this = _super.call(this, spawnPoint, 2 * (radius + level * 10), Object(_base__WEBPACK_IMPORTED_MODULE_1__["randomColor"])()) || this;
        _this.target = target;
        _this.points = 200 + level * 50;
        _this.baseSpeed = 0.75 + (Math.random() * 0.25);
        _this.inPlay = false;
        var angle = _this.center.angleTo(target);
        _this.velocity = new _base__WEBPACK_IMPORTED_MODULE_1__["Velocity"](Math.cos(angle) * _this.baseSpeed * 4, Math.sin(angle) * _this.baseSpeed * 4);
        return _this;
    }
...
var HomingEnemy = /** @class */ (function (_super) {
    ...
    function HomingEnemy(spawn, target, level) {
        ...
        _this.border = new _base__WEBPACK_IMPORTED_MODULE_1__["Color"](328, 60, 54);
        return _this;
    }
...
var OscilatingEnemy = /** @class */ (function (_super) {
    ...
    function OscilatingEnemy(spawn, target, level) {
        ...
        _this.border = new _base__WEBPACK_IMPORTED_MODULE_1__["Color"](258, 40, 60);
        return _this;
    }
...
var Boss = /** @class */ (function (_super) {
    ...
    function Boss(spawnPoint, player) {
        var _this = _super.call(this, spawnPoint, player.center, 8) || this;
        _this.player = player;
        _this.radius = Math.min(150, _this.radius);
        _this.drawRadius = _this.radius;
        _this.baseSpeed = 1.2;
        _this.points = 10000;
        _this.frame = 0;
        _this.isBoss = true;
    ...
    Boss.prototype.update = function (c) {
        ...
        this.color = new _base__WEBPACK_IMPORTED_MODULE_1__["Color"](h, s, 50);
        var angle = this.center.angleTo(this.player.center);
        this.velocity = new _base__WEBPACK_IMPORTED_MODULE_1__["Velocity"](Math.cos(angle) * this.baseSpeed, Math.sin(angle) * this.baseSpeed);
        this.center.x += this.velocity.x;
        this.center.y += this.velocity.y;
    };
...
var Mouse = /** @class */ (function () {
    function Mouse(down, point) {
        if (down === void 0) { down = false; }
        if (point === void 0) { point = new _base__WEBPACK_IMPORTED_MODULE_0__["Point"](undefined, undefined); }
        this.down = down;
        this.point = point;
    }
    return Mouse;
...
var Particles = /** @class */ (function () {
    ...
    Particles.prototype.create = function (at, color, amount, angle) {
        // angle determines the direction particles will shoot off in
        var xBias = Math.cos(angle);
        var yBias = Math.sin(angle);
        for (var i = 0; i < amount; i++) {
            this.particles.push(new Particle(new _base__WEBPACK_IMPORTED_MODULE_1__["Point"](at.x, at.y), Math.random() * 2, color, new _base__WEBPACK_IMPORTED_MODULE_1__["Velocity"]((Math.random() - 0.5) + xBias, (Math.random() - 0.5) + yBias)));
        }
    };
...
var BackgroundParticles = /** @class */ (function () {
    function BackgroundParticles(topLeft, bottomRight, spacing) {
        this.particles = [];
        this.lit = 0;
...
var Projectile = /** @class */ (function (_super) {
    ...
    function Projectile(center, radius, color, velocity, power) {
        var _this = _super.call(this, center, radius, color) || this;
...
var BackgroundMusic = /** @class */ (function () {
    ...
    Object.defineProperty(BackgroundMusic.prototype, "isBoss", {
        get: function () {
