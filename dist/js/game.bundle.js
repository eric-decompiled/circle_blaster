...
function animate() {
    ...
    if (frame % 25 && enemies.length === 0)
        Object(_spawners__WEBPACK_IMPORTED_MODULE_6__["spawnEnemies"])(enemies, 1, player.center, center);
    if (frame % 750 === 0) {
        scene.setLevel();
...
var Bounds = /** @class */ (function () {
    ...
    Bounds.prototype.near = function (c) {
        if (!this.contains(c)) {
            var dx = c.center.x - this.x;
            var dy = c.center.y - this.y;
            var dist = (dx * dx + dy * dy) - this.diagonal - c.radius;
            return dist < 0;
        }
        return true;
    };
...
var QuadTree = /** @class */ (function () {
    function QuadTree(boundary, canvas, depth) {
    ...
    QuadTree.prototype.addPath = function (ctx) {
        var b = this.boundary;
        ctx.rect(b.left, b.top, b.w * 2, b.h * 2);
        this.drawn = true;
    };
    QuadTree.prototype.addToSubQuad = function (particle) {
    ...
    QuadTree.prototype.query = function (part, fc, found) {
    ...
    QuadTree.prototype.close = function () {
        if (this.divided) {
            this.NE.close();
            this.NW.close();
            this.SE.close();
