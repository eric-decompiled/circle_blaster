...
var mouse = new _models_input__WEBPACK_IMPORTED_MODULE_3__["Mouse"]();
var keys = new _models_input__WEBPACK_IMPORTED_MODULE_3__["Keys"]();
var frame = 0;
...
function init() {
    ...
    canvas.width = innerWidth;
    canvas.height = innerHeight - _ui__WEBPACK_IMPORTED_MODULE_4__["inforBarEl"].clientHeight;
    topLeft = new _models_base__WEBPACK_IMPORTED_MODULE_2__["Point"](padding, padding);
    bottomRight = new _models_base__WEBPACK_IMPORTED_MODULE_2__["Point"](canvas.width - padding, canvas.height - padding);
...
var Mouse = /** @class */ (function () {
    function Mouse(down, point) {
        ...
        addEventListener('thisup', function () {
            _this.down = false;
        });
...
var Scene = /** @class */ (function () {
    function Scene(bgMusic, active, boss, color, score, level, startTime) {
        ...
        if (this.bgMusic.isBoss) {
            bgMusic.fade(2000);
            setTimeout(function () { return bgMusic.setSong(_music__WEBPACK_IMPORTED_MODULE_0__["defaultSong"]); }, 2000);
        }
    }
...
function initSpawnPoints(height, width) {
    spawnPoints = [
