...
var currentSong = movingMiamiSongURL;
        ...
        projectiles.forEach(function (projectile) {
            ...
            if (dist < 0.1) {
                ...
                if (enemy.hit(projectile.power)) {
                    ...
                    setTimeout(function () { return projectiles = projectiles.filter(function (p) { return p.id !== projectile.id; }); }, 0);
...
function updatePowerups() {
    powerUps.forEach(function (powerUp, index) {
        ...
        var collidedWithX = powerUp.center.x - powerUp.radius / 2 <= topLeft.x || powerUp.center.x + powerUp.radius / 2 >= bottomRight.x;
        var collidedWithY = powerUp.center.y - powerUp.radius / 3 <= topLeft.y || powerUp.center.y + powerUp.radius / 2 >= bottomRight.x;
        if (powerUp.inPlay) {
            if (collidedWithX) {
...
function spawnBoss() {
    ...
    var pushBoss = function () { return enemies.push(new _models_enemies__WEBPACK_IMPORTED_MODULE_2__["Boss"](outOfBounds(), player)); };
...
function spawnPowerUp() {
    powerUps.push(new _models_powerups__WEBPACK_IMPORTED_MODULE_3__["PowerUp"](outOfBounds(), new _models_base__WEBPACK_IMPORTED_MODULE_5__["Point"](canvas.width / 2, canvas.height / 2)));
}
function endGame() {
...
function updateProjectiles() {
    projectiles.forEach(function (projectile) {
        var collidedWithX = projectile.center.x - projectile.radius + projectile.velocity.x < topLeft.x || projectile.center.x + projectile.radius + projectile.velocity.x > bottomRight.x;
        var collidedWithY = projectile.center.y - projectile.radius + projectile.velocity.y < topLeft.y || projectile.center.y + projectile.radius + projectile.velocity.y > bottomRight.y;
        if (collidedWithX) {
...
var Circle = /** @class */ (function () {
    function Circle(center, radius, color, collisions, friction) {
        ...
        if (friction === void 0) { friction = 0.99995; }
        this.center = center;
        this.radius = radius;
        this.color = color;
...
var Enemy = /** @class */ (function (_super) {
    ...
    function Enemy(spawnPoint, target, level) {
        ...
        _this = _super.call(this, spawnPoint, 2 * (radius + level * 10), randomColor()) || this;
        ...
        _this.velocity = new _base__WEBPACK_IMPORTED_MODULE_1__["Velocity"](Math.cos(angle) * _this.baseSpeed * 2, Math.sin(angle) * _this.baseSpeed * 2);
        return _this;
    }
...
var Boss = /** @class */ (function (_super) {
    ...
    function Boss(spawnPoint, player) {
        var _this = _super.call(this, spawnPoint, 250, 'deeppurple') || this;
        _this.player = player;
        _this.drawRadius = 250;
        _this.baseSpeed = 1.2;
        _this.points = 10000;
        _this.frame = 0;
        _this.isBoss = true;
...
var Player = /** @class */ (function (_super) {
    ...
    function Player(topLeft, bottomRight, color, keys) {
        var _this = _super.call(this, new _base__WEBPACK_IMPORTED_MODULE_0__["Point"]((topLeft.x + bottomRight.x) / 2, (topLeft.y + bottomRight.y) / 2), playerRadius, color) || this;
    ...
    Player.prototype.shoot = function (_a) {
        var x = _a.x, y = _a.y;
        var target = new _base__WEBPACK_IMPORTED_MODULE_0__["Point"](x, y);
...
var PowerUp = /** @class */ (function (_super) {
    ...
    function PowerUp(spawnPoint, target) {
        var _this = _super.call(this, spawnPoint, (14 + 19) / 2, 'white') || this;
