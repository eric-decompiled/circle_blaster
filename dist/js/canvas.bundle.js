...
var backgroundMusic = new Audio(albatrossSongURL);
    ...
    enemies.forEach(function (enemy, index) {
        ...
        projectiles.forEach(function (projectile, projectileIndex) {
            ...
            if (dist - enemy.radius - projectile.radius < 0.1 && enemy.radius > 0) {
                var splashAmount = Math.max(16, enemy.radius / 8);
                ...
                if (enemy.hit(projectile.power)) {
                    ...
                    hitSplash(projectile, enemy.color, splashAmount_1, splashAngle);
...
function hitSplash(projectile, color, amount, angle) {
    // particles should be bias to break away from enemy
    var xBias = Math.cos(angle) * 1.1;
    var yBias = Math.sin(angle) * 1.1;
    for (var i = 0; i < amount; i++) {
        particles.push(new _models_particles__WEBPACK_IMPORTED_MODULE_4__["Particle"](projectile.x, projectile.y, Math.random() * 2, color, {
