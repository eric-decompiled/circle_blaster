...
function init() {
  ...
  backgroundParticles = [];
  var spacing = 30;
  var xDots = Array(Math.trunc(canvas.width / spacing)).keys();

  for (var x in _toConsumableArray(xDots)) {
